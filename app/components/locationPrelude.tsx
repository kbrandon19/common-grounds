  ...
  return (
    <>
      ...
      <div className="w-full h-auto relative mb-30 ">
        <div
          className="w-full h-170 absolute inset-x-0 top-0 z-0 bg-[url('https://res.cloudinary.com/dujkjy2e2/image/upload/v1758307490/Common%20Grounds/Background/CGbackground-Green_n7d9mn.png')] bg-repeat bg-[length:500px_auto] lg:bg-[length:1000px_auto] bg-top-left opacity-25"
          style={{
            backgroundImage: `url(https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUD_NAME}/image/upload/v1772162928/Common%20Grounds/Background/Green_Coffee_Bean.webp)`,
          }}
        />
        ...
        <div className="w-full h-auto  ">
          ...
          >
            <path
              fill="#0f4c4d"
              fillOpacity="1"
              d="M0,96L48,101.3C96,107,192,117,288,112C384,107,480,85,576,90.7C672,96,768,128,864,122.7C960,117,1056,75,1152,64C1248,53,1344,75,1392,85.3L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
            ></path>
          </svg>
        </div>
        ...
        <div className="relative z-6 flex flex-col-reverse md:flex-row bg-white md:rounded-xl shadow-lg overflow-hidden max-w-6xl mx-auto -mt-50 md:-mt-72 mb-12">
          {/* Google Map Section */}
