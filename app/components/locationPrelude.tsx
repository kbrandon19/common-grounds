...
async function locationPrelude() {
  ...
  return (
    <div className="w-full h-auto relative ">
      <div className="w-full h-200 absolute inset-x-0 top-0 z-0 bg-[url('https://res.cloudinary.com/dujkjy2e2/image/upload/v1758307490/Common%20Grounds/Background/CGbackground-Green_n7d9mn.png')] bg-repeat bg-[length:500px_auto] lg:bg-[length:1000px_auto] bg-top-left opacity-25" />
      ...
      <div className="w-full h-auto  " id="Contact">
        ...
        >
          <path
            d="M0 96L120 117.3C240 139 480 181 720 165.3C960 149 1200 75 1320 37.3L1440 0V320H1320C1200 320 960 320 720 320C480 320 240 320 120 320H0V96Z"
            fill="#0f4c4d"
          />
        </svg>
      </div>
      ...
      <div className="flex flex-col md:flex-row bg-white rounded-xl shadow-lg overflow-hidden max-w-6xl mx-auto -mt-40 mb-12">
        {/* Google Map Section */}
