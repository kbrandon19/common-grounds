...
async function locationPrelude() {
  ...
  return (
    <div className="w-full h-auto relative" id="Contact">
      ...
      <div className="w-full h-screen absolute inset-x-0 top-0 z-0 bg-[url('https://res.cloudinary.com/dujkjy2e2/image/upload/v1758307490/Common%20Grounds/Background/CGbackground-Green_n7d9mn.png')] bg-repeat bg-size[length:1000px_auto] bg-top-left opacity-25" />
