  ...
  return (
    // Outter Container
      ...
      <div className="relative w-full h-screen bg-[#9C002B] text-white " style={{ height: "calc(100vh)" }} id="/">
        ...
        {/* start of wave svg */}
        <div className="w-full h-80"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">    <path fill="#9C002B" fillOpacity="1" d="M0,96L48,101.3C96,107,192,117,288,112C384,107,480,85,576,90.7C672,96,768,128,864,122.7C960,117,1056,75,1152,64C1248,53,1344,75,1392,85.3L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
